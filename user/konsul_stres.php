...
$questions_query = "SELECT question_text, nilai_a, nilai_b, nilai_c, nilai_d FROM questions_s";
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h2 class="card" style="background-color: #69BE9D; color: white; padding: 25px 50px;">Konsultasi Stres</h2>
    ...
    <script>
        ...
        function displayResultCategory(totalScore) {
            ...
            if (totalScoreForwardChaining >= 0 && totalScoreForwardChaining <= 14) {
                resultCategory = 'Normal';
                recommendations = [
                    "Pertahankan kebiasaan sehat seperti cukup tidur dan olahraga.",
                    "Jaga keseimbangan antara kerja dan waktu santai."
                ];
            } else if (totalScoreForwardChaining > 15 && totalScoreForwardChaining <= 18) {
                resultCategory = 'Ringan';
                recommendations = [
                    "Coba identifikasi apa yang bikin stres dan atur cara mengatasinya.",
                    "Luangkan waktu untuk aktivitas yang kamu nikmati dan buat rileks."
                ];
            } else if (totalScoreForwardChaining > 19 && totalScoreForwardChaining <= 25) {
                resultCategory = 'Sedang';
                recommendations = [
                    "Pertimbangkan ngobrol dengan konselor untuk mengelola stres.",
                    "Fokus pada teknik relaksasi seperti meditasi atau yoga.",
                    "Pastikan kamu makan dengan baik dan tidur cukup."
                ];
            } else if (totalScoreForwardChaining > 26 && totalScoreForwardChaining <= 33) {
                resultCategory = 'Berat';
                recommendations = [
                    "Temui profesional kesehatan mental untuk bantuan lebih lanjut.",
                    "Cobalah terapi untuk mengelola stres.",
                    "Pertimbangkan perubahan gaya hidup untuk mengurangi stres."
                ];
            } else if (totalScoreForwardChaining > 34) {
                resultCategory = 'Sangat Berat';
                recommendations = [
                    "Segera cari bantuan dari profesional kesehatan mental.",
                    "Pertimbangkan terapi intensif dan dukungan sosial.",
                    "Jaga kesehatan fisik dan mental dengan kebiasaan sehat."
                ];
            }
