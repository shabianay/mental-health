...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_query = "UPDATE users SET Namalengkap = '$full_name', email = '$email', phoneNumber = '$phone_number', angkatan = '$angkatan', gender = '$gender' $password_update WHERE id = $user_id";
    $update_result = mysqli_query($koneksi, $update_query);

    if ($update_result) {
        header("Location: edit_user.php?id=$user_id&success=true");
        exit();
    } else {
        $error_message = "Error updating user: " . mysqli_error($koneksi);
    }
}
