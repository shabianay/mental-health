...
$retrieveQuery = "SELECT * FROM `questions_d`";
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $insertQuery = "INSERT INTO questions_d (kode, nilai_a, nilai_b, nilai_c, nilai_d, question_text) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = mysqli_prepare(
        $koneksi,
        $insertQuery
    );
                ...
                <div class="container-fluid">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="soal_depresi.php">
                    ...
                    if ($result) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo "<a href='edit_soal_depresi.php?id=" . $row['id_soal'] . "' class='btn btn-warning btn-sm'>Edit</a>";
                            echo "&nbsp;";
                            echo "<a href='../hapus_soal_depresi.php?id=" . $row['id_soal'] . "' class='btn btn-danger btn-sm'>Hapus</a>";
                            echo "</td>";
                            echo "</tr>";
